...
import type {UserProfile} from './getRandomUserProfile';
import {createWebRTCProvider, createWebsocketProvider} from './providers';

// Embedded (in an iframe on itsdatta.com) when ?embed is present.
...
export default function App() {
  ...
  // Live theme sync from the host (itsdatta) — relayed down by collab.html.
  useEffect(() => {
